                ...
                <div>
                    ...
                    <div className="relative">
                        <input
                            ...
                            required
                        />
                        <p className="absolute bottom-2.5 right-4 select-none" onClick={handleRepeatPasswordToggle}>
                            {
                                showRepeatPassword ? <BiShow className=" text-gray-600 cursor-pointer" size={20} /> : <BiHide className=" text-gray-600 cursor-pointer" size={20} />
                            }
                        </p>
                    </div>
